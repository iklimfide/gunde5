...
(function (global) {
    ...
    function showToastUyeGerekli(mesaj) {
        showToast(
            mesaj || 'Bu işlem yalnızca yönetici oturumunda kullanılabilir.',
            'hata'
        );
    }
    ...
    function guncelleModalScrollKilidi() {
        document.body.style.overflow = authModalAcikMi() ? 'hidden' : '';
    }
