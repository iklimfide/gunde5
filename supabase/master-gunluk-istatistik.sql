-- Günlük trafik + hikaye okuma (site_ziyaretler + site_analytics_events)
-- SQL Editor'da bir kez Run. İstatistikler sayfası master_gunluk_istatistik çağırır.
-- index-analytics.sql ve ziyaret-trafik.sql sonrası.
